          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <form action="{{ route('order_moderator.orders', ['language'=>app()->getLocale()]) }}" method="get" class="form-inline">
                  ...
                  <a href="{{ route('order_moderator.orders', ['language'=>app()->getLocale()]) }}" class="btn btn-secondary">{{__('Reset')}}</a>
                </form>
              </div>
              <div class="card-body">
